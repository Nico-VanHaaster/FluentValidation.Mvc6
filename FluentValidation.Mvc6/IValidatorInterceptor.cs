...
namespace FluentValidation.Mvc6
{
    ...
    public interface IValidatorInterceptor
    {
        ...
        ValidationContext BeforeMvcValidation(ActionContext controllerContext, ValidationContext validationContext);
        ...
        /// <returns>Validation Context</returns>
        ValidationResult AfterMvcValidation(ActionContext controllerContext, ValidationContext validationContext, ValidationResult result);
    }
}
