...
namespace FluentValidation.Validators {
	...
	public class GreaterThanOrEqualValidator : AbstractComparisonValidator  {
		public GreaterThanOrEqualValidator(IComparable value) : base(value, () => Messages.GreaterThanOrEqualError) {
		}

		public GreaterThanOrEqualValidator(Func<object, object> valueToCompareFunc, MemberInfo member)
			: base(valueToCompareFunc, member, () => Messages.GreaterThanOrEqualError) {
		}
