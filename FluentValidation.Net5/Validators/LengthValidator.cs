...
namespace FluentValidation.Validators
{
    ...
    public class LengthValidator : PropertyValidator, ILengthValidator
    {
        ...
        public LengthValidator(int min, int max) : this(min, max, () => Messages.LengthError)
        {
        }
        ...
        public LengthValidator(Func<object, int> min, Func<object, int> max)
            : this(min, max, () => Messages.LengthError)
        {
        }
    ...
    {
        public ExactLengthValidator(int length) : base(length, length, () => Messages.ExactLengthError)
        {

        }

        public ExactLengthValidator(Func<object, int> length)
            : base(length, length, () => Messages.ExactLengthError)
        {
    ...
    {
        public MaximumLengthValidator(int max) : this(max, () => Messages.LengthError)
        {
    ...
    {
        public MinimumLengthValidator(int min) : this(min, () => Messages.LengthError)
        {
